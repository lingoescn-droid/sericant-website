...
const pdf = "/reports/sericant-sample-waterjet-beijing.pdf";
    ...
    <main>
      ...
      <section className="section realSampleIntro">
        ...
        <div className="homeSampleGrid">
          <div>
            ...
            <p className="sampleIntro">Entity identifier: 911101056738046445</p>
            <p lang="zh-Hans">沃特杰特贸易（北京）有限公司</p>
            <p className="sampleDisclaimer">The PDF uses the English rendering “Waterjet Trading (Beijing) Co., Ltd.” as an AI-generated translation. It is not presented as a verified registered English name.</p>
            <p className="sampleStatus">REGISTRY STATUS: DEREGISTERED · APPROVAL DATE: 2 FEBRUARY 2026</p>
            ...
            <dl className="sampleDetails"><div><dt>Format</dt><dd>15-page English PDF · Watermarked</dd></div><div><dt>Research cut-off</dt><dd>5 September 2026</dd></div><div><dt>Reference</dt><dd>SER-SAMPLE-20260905-002</dd></div></dl>
            ...
            <p className="sampleDisclaimer">No sign-up required. This sample was not commissioned by or endorsed by the subject company, its shareholder or any authority. It is not legal advice, a formal KYC determination or an AML certification. Registry status: deregistered. Approval date shown in the public disclosure report: 2 February 2026.</p>
          </div>
      ...
      <section className="section sampleScopeSection">
        ...
        <div className="homeSampleGrid">
          ...
          <div><h2>What this sample<br /><em>does—and does not—cover.</em></h2><p className="sampleIntro">Based solely on an Enterprise Credit Information Disclosure Report from the National Enterprise Credit Information Publicity System, generated on 5 September 2026.</p><p className="sampleIntro">Findings are limited to the fields displayed in that report. “No information displayed” does not establish that no record or issue exists.</p><p className="sampleDisclaimer">No interviews, site visit, document authentication, litigation search, adverse-media review, legal analysis, KYC determination or beneficial-ownership verification are included. This sample does not establish the scope of every paid engagement.</p><Link href="/methodology" className="textLink">Read our methodology →</Link></div>
        </div>
      </section>
