  ...
  return (
    <main className="legalPage">
      ...
      <article className="legalContent">
        ...
        <p className="lede" style={{ marginBottom: "52px" }}>Last updated: 5 September 2026</p>
