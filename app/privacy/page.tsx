...
const sections = [
  ["1. Scope", <p>This Policy explains how Sericant Limited, Hong Kong (“Sericant”, “we”, “us”) handles information relating to website visitors, contacts, scope requests and customers of our company intelligence services. The interactive demonstration available on this website is illustrative. Sericant’s paid research services are performed separately and do not provide customers with direct access to a live third-party company-data feed.</p>],
